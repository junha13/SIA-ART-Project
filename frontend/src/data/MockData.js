...
export const MOCK_ARTWORKS = [
    ...
    { id: 1, title: '팀장의 고뇌', subtitle: '코드와 씨름하는 하루', artist: '김준하', artistId: 101, location: '만안구', price: 150000, likes: 6, category: '회화', image: 'public/assets/media/stock/600x600/img-50.jpg', following: true, info: { size: '45cm x 53cm', material: '캔버스 유화물감', year: '2023', weight: '1.5kg' }, description: '이건 진짜 엄청난 명작이다.' },
    ...
    { id: 18, title: '사계절 화병', artist: '고예원', artistId: 104, location: '영등포구', price: 290000, likes: 18, category: '도예', image: 'public/assets/media/stock/600x600/img-43.jpg', following: true, info: { size: '40cm', material: '청자', year: '2023' }, description: '사계절을 담은 유약 처리.' },
    { id: 19, title: '카페의 하루', artist: '주영민', artistId: 105, location: '동작구', price: 110000, likes: 90, category: '회화', image: 'public/assets/media/stock/600x600/img-58.jpg', following: false, info: { size: '30cm x 30cm', material: '오일 파스텔', year: '2024' }, description: '잔잔한 카페 풍경.' },
    { id: 20, title: '별빛 아래', artist: '박민호', artistId: 106, location: '서초구', price: 450000, likes: 15, category: '사진', image: 'public/assets/media/stock/600x600/img-46.jpg', following: true, info: { size: 'A1', material: '금속 인화', year: '2025' }, description: '은하수를 담은 고급 인화.' },
];
