...
export const useFollowingStore = defineStore('following', () => {
    ...
    const artists = ref([
        { id: 1, name: '김작가', bio: '추상화 전문 예술가', avatar: 'public/assets/media/avatars/300-1.jpg' },
        { id: 2, name: '이예술', bio: '현대 미술과 설치미술 작가', avatar: 'public/assets/media/avatars/300-2.jpg' },
